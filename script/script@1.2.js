...
function initImageReveal() {
  let imageReveal = gsap.utils.toArray("[data-parallax]");
  gsap.set(imageReveal, { clipPath: "inset(50%)" });

  let targetOne = document.querySelector('[data-move="1"]');
  let targetTwo = document.querySelector('[data-move="2"]');
  let targetThree = document.querySelector('[data-move="3"]');
